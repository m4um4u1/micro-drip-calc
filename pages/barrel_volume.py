...
barrel_width_upper = st.number_input('Barrel width in the top and bottom (cm)', min_value=0.0, value=60.0)
barrel_width_middel = st.number_input('Barrel width in the middel (cm)', min_value=0.0, value=70.0)
barrel_height = st.number_input('Barrel height (cm)', min_value=0.0, value=80.0)
